...
const ENV_VARS = [
  ...
  "RANGE_ENGINE_ENABLED",
  "DE_ESCALATION_ENABLED",
  "DE_ESCALATION_FRACTION",
  "DE_ESCALATION_SIZE_MULTIPLIER",
  "ADAPTIVE_ENGINE_SIZING_ENABLED",
  "SESSION_EDGE_SIZING_ENABLED",
  "EDGE_MIN_SAMPLES",
  "ALERT_WEBHOOK_URL",
  "KILL_SWITCH_FILE",
  "UNRESTRICTED_MANUAL_TRADING",
  ...
  "DEMO_RANGE_ENGINE_ENABLED",
  "DEMO_DE_ESCALATION_ENABLED",
  "DEMO_DE_ESCALATION_FRACTION",
  "DEMO_DE_ESCALATION_SIZE_MULTIPLIER",
  "DEMO_ADAPTIVE_ENGINE_SIZING_ENABLED",
  "DEMO_SESSION_EDGE_SIZING_ENABLED",
  "DEMO_EDGE_MIN_SAMPLES",
  "DEMO_ALERT_WEBHOOK_URL",
...
describe("loadExecutionConfig", () => {
  ...
  it("defaults to the same values for live and demo when nothing is set", () => {
    expect(loadExecutionConfig("live")).toEqual({
      ...
      trendContinuationEnabled: false,
      deEscalationEnabled: true,
      deEscalationFraction: 0.5,
      deEscalationSizeMultiplier: 0.5,
      adaptiveEngineSizingEnabled: true,
      sessionEdgeSizingEnabled: true,
      edgeMinSamples: 10,
      alertWebhookUrl: undefined,
      killSwitchFile: ".trading-paused",
      unrestrictedManualTrading: false,
    });
